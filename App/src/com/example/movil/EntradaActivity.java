...
public class EntradaActivity extends Activity {	
	  ...
	  private static final String TAG = "Entrada";
	  ...
	  private static String url = "http://200.14.84.183/~17325436/Appmovil/obtenerEnsalada.php";
	  //JSON Node Names
	  ...
	  JSONArray android = null;
	    ...
	    public void next(View view){
			...
			//Enviar sólo objetos que contengan cantidad > 0
			...
			Mesa.observaciones += "Entrada: " + observacion + "\n";
			
			Log.d("SE ENVIA ", "observaciones: " + observacion);
	    ...
	    private class JSONParse extends AsyncTask<String, String, JSONObject> {
	      ...
	      @Override
	       ...
	       //descripcion = (TextView)findViewById(R.id.descripcion);
	            pDialog = new ProgressDialog(EntradaActivity.this);
	      ...
	      @Override
	       ...
	       @Override
	         ...
	         try {
	            ...
	            ListAdapter adapter = new SimpleAdapter(EntradaActivity.this, oslist, R.layout.list_v,
