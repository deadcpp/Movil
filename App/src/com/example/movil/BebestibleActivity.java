...
public class BebestibleActivity extends Activity {
	  ...
	  private static String url = "http://200.14.84.183/~17325436/Appmovil/obtenerBebestible.php";
	  //JSON Node Names
	  ...
	  JSONArray android = null;
	    ...
	    public void next(View view){
			...
			Mesa.observaciones += "Bebestible: " + observacion + "\n";
	    	...
	    	private ProgressDialog pDialog;
		      @Override
		       ...
		       //descripcion = (TextView)findViewById(R.id.descripcion);
		            pDialog = new ProgressDialog(BebestibleActivity.this);
		      ...
		      @Override
		       ...
		       @Override
		         ...
		         try {
		            ...
		            ListAdapter adapter = new SimpleAdapter(BebestibleActivity.this, oslist, R.layout.list_v,
