...
public class PlatoActivity extends Activity {
	  ...
	  private static String url = "http://200.14.84.183/~17325436/Appmovil/obtenerPlatos.php";
	  //JSON Node Names
	  ...
	  JSONArray android = null;
	    ...
	    public void next(View view){
			...
			Mesa.observaciones += "Plato: " + observacion + "\n";
	    	...
	    	private ProgressDialog pDialog;
		      @Override
		       ...
		       //descripcion = (TextView)findViewById(R.id.descripcion);
		            pDialog = new ProgressDialog(PlatoActivity.this);
		      ...
		      @Override
		       ...
		       @Override
		         ...
		         try {
		            ...
		            ListAdapter adapter = new SimpleAdapter(PlatoActivity.this, oslist, R.layout.list_v,
